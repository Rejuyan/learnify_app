...
class _QuizScreenState extends State<QuizScreen>
  ...
  void _checkAnswer() {
    ...
    setState(() {
      _showResult = true;
      if (_selectedOption == quiz.correctIndex) _correctCount++;
    });
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...List.generate(quiz.options.length, (i) {
                      bool? isCorrect;
                      if (_showResult) isCorrect = i == quiz.correctIndex;
                      return QuizOption(
                        text: quiz.options[i],
                        index: i,
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: _showResult ? widget.course.color : AppTheme.primaryPurple,
  ...
  Widget _buildResultScreen() {
    ...
    final percentage = total > 0 ? ((_correctCount / total) * 100).toInt() : 0;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'You scored $_correctCount out of $total ($percentage%)',
                ...
                if (isPassed)
                  ElevatedButton.icon(
                    onPressed: () async {
                      // Award certificate (local)
                      await _ds.awardCertificate(widget.course.id, widget.course.title);
                      if (mounted) {
                ...
                OutlinedButton(
                  onPressed: () => Navigator.pop(context),
                  child: Text(isPassed ? 'Back to Course' : 'Try Again'),
                ),
              ],
            ),
          ),
